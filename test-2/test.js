// ============================================
// EXAMEN B2 - TEST 2 (Bildung & Studium)
...
const TEST_ID = 'examen-b2-test-2';
...
const ANSWER_KEY = {
    ...
    g2: { correct: ['obwohl'], points: 1 },
    g3: { correct: ['weil'], points: 1 },
    g4: { correct: ['deshalb'], points: 1 },
    g5: { correct: ['trotzdem'], points: 1 },

    // ---- B. Prepoziții (5 × 1p = 5p) ----
    g6:  { correct: ['b'], points: 1 },  // an der Universität
    g7:  { correct: ['a'], points: 1 },  // bewerben für
    g8:  { correct: ['b'], points: 1 },  // nach dem Abitur (Dativ)
    g9:  { correct: ['c'], points: 1 },  // sich interessieren für
    g10: { correct: ['d'], points: 1 },  // während des Studiums (Genitiv)

    // ---- C. Aktiv → Passiv (5 × 2p = 10p) ----
    g11: { correct: [
        'zwanzig neue studiengänge werden von der universität angeboten',
        'zwanzig neue studiengänge werden angeboten'
    ], points: 2 },
    g12: { correct: [
    ...
    g13: { correct: [
        'eine hausarbeit wird von den studenten geschrieben',
        'eine hausarbeit wird geschrieben'
    ], points: 2 },
    g14: { correct: [
        'eine studienreise wird von der schule organisiert',
        'eine studienreise wird organisiert'
    ], points: 2 },
    g15: { correct: [
        'die auszubildenden werden von der firma bezahlt',
        'die auszubildenden werden bezahlt'
    ], points: 2 },

    // ---- D. Rechtschreibung — alegere (5 × 1p = 5p) ----
    o1: { correct: ['c'], points: 1 },  // Prüfung
    o2: { correct: ['b'], points: 1 },  // Schüler
    o3: { correct: ['a'], points: 1 },  // Schule
    o4: { correct: ['a'], points: 1 },  // lesen
    o5: { correct: ['b'], points: 1 },  // fleißig

    // ---- E. Găsește greșeala — rescrie corect (5 × 1p = 5p) ----
    o6:  { correct: ['universität'], wrong: 'universität', right: 'Universität', points: 1 },  // substantiv cu literă mare
    o7:  { correct: ['fleißig'], wrong: 'Fleißig', right: 'fleißig', points: 1, strictUmlaut: true },  // adjectiv cu literă mică + ß strict
    o8:  { correct: ['bruder'], wrong: 'bruder', right: 'Bruder', points: 1 },  // substantiv cu literă mare
    o9:  { correct: ['schwierig'], wrong: 'Schwierig', right: 'schwierig', points: 1 },  // adjectiv cu literă mică
    o10: { correct: ['große'], wrong: 'grosse', right: 'große', points: 1, strictUmlaut: true },  // ß în loc de ss — STRICT

    // ---- 2. Hörverstehen ----
    // h1-h4 (multiple choice, 4 × 3p = 12p)
    h1: { correct: ['b'], points: 3 },  // Erwachsenen aus ganz Europa
    h2: { correct: ['c'], points: 3 },  // kostenlos
    h3: { correct: ['c'], points: 3 },  // DACH + international
    h4: { correct: ['b'], points: 3 },  // online sau telefonic
    // h5-h8 (Richtig/Falsch, 4 × 2p = 8p)
    h5: { correct: ['R'], points: 2 },  // 15 ani
    h6: { correct: ['F'], points: 2 },  // lucrează cu universități, nu firme
    h7: { correct: ['R'], points: 2 },  // prima beratung gratuită
    h8: { correct: ['R'], points: 2 },  // 0800

    // ---- 3. Leseverstehen ----
    // l1-l5 (multiple choice, 5 × 3p = 15p)
    l1: { correct: ['b'], points: 3 },  // Bachelor Internationale Wirtschaft
    l2: { correct: ['b'], points: 3 },  // Lebenslauf + Abiturzeugnisse + Motivationsschreiben
    l3: { correct: ['b'], points: 3 },  // 1500 Euro
    l4: { correct: ['c'], points: 3 },  // 50/50 Theorie/Praxis
    l5: { correct: ['b'], points: 3 },  // Frankreich, Spanien, Italien
...
async function confirmSubmit() {
    ...
    try {
        ...
        a.href = url;
        a.download = `raspunsuri-test-2-${nume}-${Date.now()}.json`;
